...
class Config:
    ...
    def from_args(self, args=sys.argv[1:]):
        ...
        parser.add_argument('--est', dest='estimator', type=str, default='ipca', help='The algorithm to use [pca, fbpca, cupca, spca, ica, kpca]')
        ...
        parser.add_argument('-c', dest='components', type=int, default=70, help='Number of components to keep')
